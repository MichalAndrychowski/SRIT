...
Zawartość
Platforma Centralna: OpenCTI z konektorami (CVE, KEV, MITRE, MISP).
Endpoint Agent: Zestaw skryptów PowerShell realizujących Active Response i Offline Buffering.
Pipeline IOC: (Opcjonalnie) Lokalne skrypty przetwarzające dane z MISP.
Dokumentacja
Architektura: docs/architecture.md
Dokumentacja Agenta (EDR): docs/agent.md
Scenariusze demo: docs/scenarios.md
Znane problemy: docs/known-issues.md
Harmonogram (Backup): docs/backup-windows-task.md
Powiadomienia e‑mail: docs/misp-email.md
